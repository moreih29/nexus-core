...
**위반 신호**: Weak·Unreliable 출처가 Strong과 동등 인용, 인용 없는 "일반적으로 알려진" 진술, 조작·존재하지 않는 출처, 단일 사례에서 일반화된 결론, 등급 평가 없이 "강한 증거"로 단정.
